...
import com.truecaller.commons.helpers.PERMISSION_CALL_PHONE
import com.truecaller.commons.helpers.PERMISSION_WRITE_CONTACTS
...
class ContactsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        createViewHolder(R.layout.item_contact_without_number, parent)
    ...
    private fun getSelectedItems() =
        contacts.filter { selectedKeys.contains(it.rawId) } as ArrayList<SimpleContact>
    ...
    override fun onViewRecycled(holder: ViewHolder) {
        ...
        if (!activity.isDestroyed && !activity.isFinishing) {
            Glide.with(activity)
                .clear(holder.itemView.findViewById<ImageView>(R.id.item_contact_image))
        }
    }

    private fun setupView(view: View, contact: SimpleContact) {
        view.apply {
            findViewById<FrameLayout>(R.id.item_contact_frame).isSelected =
                selectedKeys.contains(contact.rawId)
