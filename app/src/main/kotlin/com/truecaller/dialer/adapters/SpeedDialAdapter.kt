...
class SpeedDialAdapter(
    ...
    override fun getItemSelectionKey(position: Int) =
        speedDialValues.getOrNull(position)?.hashCode()

    override fun getItemKeyPosition(key: Int) =
        speedDialValues.indexOfFirst { it.hashCode() == key }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        createViewHolder(R.layout.item_speed_dial, parent)
    ...
    private fun getSelectedItems() =
        speedDialValues.filter { selectedKeys.contains(it.hashCode()) } as ArrayList<SpeedDial>
