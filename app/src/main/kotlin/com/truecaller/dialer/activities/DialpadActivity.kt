...
import com.truecaller.dialer.extensions.getKeyEvent
import com.truecaller.dialer.extensions.startCallIntent
...
class DialpadActivity : SimpleActivity() {
    ...
    private fun dialpadValueChanged(text: String) {
        ...
        val filtered = allContacts.filter {
            val convertedName =
                PhoneNumberUtils.convertKeypadLettersToDigits(it.name.normalizeString())
