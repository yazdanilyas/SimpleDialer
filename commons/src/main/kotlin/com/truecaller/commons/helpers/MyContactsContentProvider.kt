...
import com.truecaller.commons.extensions.getIntValue
import com.truecaller.commons.extensions.getStringValue
                ...
                cursor?.use {
                    if (cursor.moveToFirst()) {
                        do {
                            ...
                            val contact =
                                SimpleContact(rawId, contactId, name, photoUri, phoneNumber)
