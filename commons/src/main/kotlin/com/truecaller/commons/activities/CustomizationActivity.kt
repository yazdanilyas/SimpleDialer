...
import com.truecaller.commons.dialogs.*
import com.truecaller.commons.extensions.*
import com.truecaller.commons.helpers.*
import com.truecaller.commons.models.MyTheme
import com.truecaller.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun getThemeNavigationColor(themeId: Int) =
        if (themeId == THEME_BLACK_WHITE) Color.BLACK else baseConfig.defaultNavigationBarColor
    ...
    private fun setupColorsPickers() {
        ...
        customization_navigation_bar_color.setFillWithStroke(
            curNavigationBarColor,
            curBackgroundColor
        )
