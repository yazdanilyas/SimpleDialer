package com.truecaller.commons.activities
...
import com.truecaller.commons.asynctasks.CopyMoveTask
import com.truecaller.commons.dialogs.ConfirmationDialog
import com.truecaller.commons.dialogs.ExportSettingsDialog
import com.truecaller.commons.dialogs.FileConflictDialog
import com.truecaller.commons.dialogs.WritePermissionDialog
import com.truecaller.commons.extensions.*
import com.truecaller.commons.helpers.*
import com.truecaller.commons.interfaces.CopyMoveListener
import com.truecaller.commons.models.FAQItem
import com.truecaller.commons.models.FileDirItem
import java.io.File
            ...
            if (resultCode == Activity.RESULT_OK && resultData != null && resultData.data != null) {
                val isProperPartition =
                    partition.isEmpty() || !sdOtgPattern.matcher(partition)
                        ...
                        .matches() && resultData.dataString!!.contains(
                        partition
                    ))
...
//        }
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName =
                baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro")
