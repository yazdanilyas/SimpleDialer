...
import com.truecaller.commons.helpers.isNougatPlus
import com.truecaller.commons.helpers.sumByInt
import com.truecaller.commons.helpers.sumByLong
        ...
        ensureBackgroundThread {
            ...
            if (!fileDirItem.isDirectory) {
                ...
                val exif = if (isNougatPlus() && activity.isPathOnOTG(fileDirItem.path)) {
                    ExifInterface(
                        (activity as BaseSimpleActivity).getFileInputStreamSync(
                            fileDirItem.path
                        )!!
                    )
